...
%%% constraint: only k light bulbs adjacent to wall(R, C, k) allowed  %%%
adjacentToWall(R, C, Rwall, Cwall) :- adjacent(R, C, Rwall, Cwall), wall(Rwall, Cwall, _).

:- row(Rwall), col(Cwall), wall(Rwall, Cwall, K), #count{ R, C : placeLightBulb(R,C), adjacentToWall(R, C, Rwall, Cwall) } > K.
