...
CNF =
\begin{align*}
&(Ab_{G1} \lor A \lor G_1) \land (Ab_{G1} \lor \neg B \lor G_1) \land (Ab_{G1} \lor \neg G_1 \lor \neg A \lor B) \land \\
&(Ab_{G2} \lor \neg A \lor G_2) \land (Ab_{G2} \lor B \lor G_2) \land (Ab_{G2} \lor \neg G_2 \lor A \lor \neg B) \land \\
&(Ab_{G3} \lor C \lor G_3) \land (Ab_{G3} \lor \neg D \lor G_3) \land (Ab_{G3} \lor \neg G_3 \lor \neg C \lor D) \land \\
&(Ab_{G4} \lor \neg C \lor G_4) \land (Ab_{G4} \lor D \lor G_4) \land (Ab_{G4} \lor \neg G_4 \lor C \lor \neg D) \land \\
&(Ab_{G5} \lor \neg G_1 \lor \neg G_2 \lor G_5) \land (Ab_{G5} \lor \neg G_5 \lor G_1) \land (Ab_{G5} \lor \neg G_5 \lor G_2) \land \\
&(Ab_{G6} \lor \neg G_3 \lor \neg G_4 \lor G_6) \land (Ab_{G6} \lor \neg G_6 \lor G_3) \land (Ab_{G6} \lor \neg G_6 \lor G_4) \land \\
&(Ab_{G7} \lor G_5 \lor G_7) \land (Ab_{G7} \lor G_6 \lor G_7) \land (Ab_{G7} \lor \neg G_7 \lor \neg G_5 \lor \neg G_6)
\end{align*}
